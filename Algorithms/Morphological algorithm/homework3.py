...
if __name__ == "__main__":
    img = cv2.imread(r'finger1.jpg',0)  ##读取图片
    ...
    img_wskelon_shape = extract_sketon(img_bin/255,B,method='shape')
    ...
    img_wskelon_distance = extract_sketon(img_bin/255,B,method='distance')
